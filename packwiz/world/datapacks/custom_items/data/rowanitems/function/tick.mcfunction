execute as @e[type=item,nbt={Item:{id:"minecraft:carved_pumpkin"}},scores={rowanitems.custom_model_data=0},tag=!rowanitems.modified] at @s if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:black_wool"}},distance=...2] run function rowanitems:replacements/top_hat
...
execute as @e[type=item,nbt={Item:{id:"minecraft:carved_pumpkin"}},scores={rowanitems.custom_model_data=6510004},tag=!rowanitems.modified] at @s if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:black_wool"}},distance=...2] run function rowanitems:replacements/topper_hat
